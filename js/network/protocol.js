...
const Protocol = {
    ...
    handleMessage(message) {
        ...
        switch (message.type) {
            ...
            case this.types.SPEED_UPDATE:
                this.handleSpeedUpdate(message.data);
                break;
    ...
    handleGameStart(data) {
        ...
        if (data.initialState) {
            ...
            if (data.initialState.expansions !== undefined) {
                state.expansions = data.initialState.expansions;
            }
            if (data.initialState.speedMultiplier !== undefined) {
                state.speedMultiplier = data.initialState.speedMultiplier;
            }
            if (data.initialState.speedUpgradeCost !== undefined) {
                state.speedUpgradeCost = data.initialState.speedUpgradeCost;
            }
    ...
    handleFullSync(data) {
        ...
        if (gameState) {
            ...
            if (gameState.expansions !== undefined) {
                state.expansions = gameState.expansions;
            }
            if (gameState.speedMultiplier !== undefined) {
                state.speedMultiplier = gameState.speedMultiplier;
            }
            if (gameState.speedUpgradeCost !== undefined) {
                state.speedUpgradeCost = gameState.speedUpgradeCost;
            }
    ...
    handleSpeedUpdate(data) {
        const { playerId, speedMultiplier, speedUpgradeCost } = data;

        // Don't process our own speed update
        if (playerId === state.localPlayerId) return;

        // Update speed for everyone
        state.speedMultiplier = speedMultiplier;
        state.speedUpgradeCost = speedUpgradeCost;

        // Update the speed button display
        if (typeof updateSpeedButtonLabel === 'function') {
    ...
    handleFullState(data) {
        ...
        if (data.speedUpgradeCost !== undefined) {
            state.speedUpgradeCost = data.speedUpgradeCost;
        }
