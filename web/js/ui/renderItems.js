...
function createItemElement(item) {
    ...
    const originX = item.x * (state.cellSize + state.gapSize);
    const originY = item.y * (state.cellSize + state.gapSize);
...
function updateItemAppearance(el, item, alpha) {
    ...
    */
    ...
    const originX = ix * (state.cellSize + state.gapSize);
    const originY = iy * (state.cellSize + state.gapSize);
